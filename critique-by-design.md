...
Regarding this question: "Can you describe to me what this is telling you?", they both explained very well my intention for both graphs. Here: " Is there anything you find surprising or confusing?" We discussed whether it was a good idea to use the car brand colors. One of the students told me that it was better not to use them since two car brands had red-like color logos: "Tesla" and "BYD", and that it could be better to use other colors that can differentiate better. On the trend line graph, one of the students didn't like the idea of the vertical lines that were identifying each quarter; he suggested to me to remove it. I decided to follow his advice. The other student suggested placing the legend at the bottom, however, I decided to keep the legend on the right, since I find it more convenient as the natural movement of our eyes is from top left to top right.
On the "Who do you think is the intended audience for this?", they pointed out "Investors" or "Market Researchers".
Finally, here " Is there anything you would change or do differently?", one said that it was OK the way it was presented and the other student said that he would add the actual car Logos in the graph as a background.
